  ...
  <div id="dome">
    <div id="shortcut">
      <div class="w" role="navigation" aria-label="顶部导航" tabindex="0">
        <ul class="fr">
          ...
          <li>
            <b @click="login" tag="li">登录2</b>
          </li>
          <li>
            <b @click="Inde" tag="li">首页</b>
          </li>
          ...
          <li @mouseenter.stop="lihover" @mouseleave.stop="invisible" style="position: relative;">
            ...
            <ul v-show="ishow" v-if="ishow" id="abcdef">
              <li>
                <router-link to="/login" tag="li">模板</router-link>
              </li>
              <li>
                <router-link to="/login/temp" tag="li">登录</router-link>
              </li>
              <li>
                <router-link to="/login/temp1" tag="li">事件</router-link>
              </li>
            </ul>
          </li>
    ...
    <div class="headertop">
      ...
      <span @click="goto('/ES6')" class="ceshi" :class="{on:'/ES6'===$router.history.current.path}">路由高亮 ES6</span>
       ...
       <span @click="goto('/bendiqingqiu')" class="ceshi" :class="{on:'/bendiqingqiu'===$router.history.current.path}">AJAX 请求</span>

    </div>
    <chachao :title="title">
      <p slot="left" class="left" @click="goto('/shop')"><b>插槽</b> shop</p>
      <p slot="right" class="right" @click="goto('/Login')">插槽 login</p>
    </chachao>
